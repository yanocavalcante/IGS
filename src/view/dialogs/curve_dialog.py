...
class CurveDialog(QDialog):
    def __init__(self, parent=None) -> None:
        ...
        self.setWindowTitle("Curve Coordinates")

        layout = QVBoxLayout(self)
        form = QFormLayout()

        self.__coords_field = QLineEdit()
        self.__coords_field.setPlaceholderText("e.g. 10,10; 50,10; 30,50; 40, 40")
    ...
    def __try_accept(self) -> None:
        try:
            ...
            if len(coords) < 4:
                raise ValueError("A Bézier Curve needs, at least, 4 points.")
